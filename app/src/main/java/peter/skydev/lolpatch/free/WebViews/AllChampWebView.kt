...
class AllChampWebView : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_all_champ_web_view)
        ...
        if (this.isNetworkConnected()) {
            ...
            this.webView.loadUrl("https://www.leagueoflegends.com/" + getURLWithLanguage(language) + "/news/tags/champion-spotlight/")
