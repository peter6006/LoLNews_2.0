...
class AllPatchWebView : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_all_patch_web_view)
        ...
        if (this.isNetworkConnected()) {
            ...
            this.webView.loadUrl("https://leagueoflegends.com/" + getURLWithLanguage(language) + "/news/tags/patch-notes/")
